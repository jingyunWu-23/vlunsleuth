...
Your task is not to classify known vulnerability labels. You must reason about whether an
anomalous function may contain a new, business-logic, cross-function, asset-flow, permission,
...
class LLMUnknownRiskAgent:
    ...
    def reason_unknown_risk(
        ...
        if self.client.__class__.__name__ == "PlaceholderLLMClient":
            return build_inconclusive_result(function, vector, "LLM API is not configured; no generated unknown risk hypothesis was produced.")
