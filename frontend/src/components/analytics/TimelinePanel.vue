...
const steps: Step[] = [
  ...
  { id: 2, label: '已知漏洞发现', desc: '8 类已知漏洞模型推理', duration: '4.1s',  status: 'done',    modelIcon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  { id: 3, label: '未知风险发现', desc: '异常行为偏离度分析与预警', duration: '5.2s', status: 'done', modelIcon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
  { id: 4, label: '跨合约关联分析', desc: '跨合约调用图交互风险检测', duration: '3.8s', status: 'done', modelIcon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
  ...
  { id: 7, label: '多维风险评分', desc: '融合模型置信度、跨合约风险、异常特征与安全规则进行函数级加权排序', duration: '1.5s',  status: 'done',    modelIcon: 'M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4' },
  { id: 8, label: 'LLM 推理定位', desc: '大语言模型推理，筛选高价值函数生成漏洞发现与攻击路径', duration: '8.6s',  status: 'done',    modelIcon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  ...
  { id: 10, label: '报告生成',     desc: '汇总所有模型输出，生成 Markdown 格式审计报告与修复建议', duration: '1.1s',  status: 'done',    modelIcon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
]
</script>
